...
# When running from source directory, use local paths
# When installed, use system paths
...
# Find NVMe temperature sensor
NVME_SENSOR=$(find_hwmon_device "nvme") || {
    log_error "NVMe temperature sensor not found"
    cleanup_handler
    exit 1
}
